...
import { GripVertical, Play, Pencil, Trash2, Timer } from 'lucide-react';
...
export default function TaskItem({ task, settings }: TaskItemProps) {
    ...
    return (
        <>
            <motion.div
                ...
                className={`glass glass-hover p-4 flex items-center gap-3 group ${
